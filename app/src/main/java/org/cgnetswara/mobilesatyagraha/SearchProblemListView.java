...
public class SearchProblemListView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_problem_list_view);
        Intent data=getIntent();
        username=data.getStringExtra(SearchPage.USERNAME);
        query=data.getStringExtra(SearchPage.QUERY);
        setTitle("Showing results for "+query);
        Log.d("show",username);

        recyclerView = (RecyclerView) findViewById(R.id.rSearchView);
    ...
    public void loadProblems(){
        final ProgressDialog progressDialog = new ProgressDialog(SearchProblemListView.this,
                R.style.AppTheme);
        progressDialog.setIndeterminate(true);
        progressDialog.setMessage("Loading Problems. Please wait...");
        progressDialog.show();

        String url = getString(R.string.base_url)+"pqblock/"+query+"/"+start+"/"+end;
